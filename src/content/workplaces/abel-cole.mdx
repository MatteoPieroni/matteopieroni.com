...
metaDescription: 'My experience at Abel & Cole, as Front End Developer, working on the e-commerce web platform.'
---

import TechnologiesList from '../../components/TechnologiesList.astro';

At Abel & Cole, my role was Front End Developer, working on their <a href="https://abelandcole.co.uk" target="_blank">e-commerce web platform</a>. The platform is based on an MVC .NET backend, that used Razor and jQuery.
