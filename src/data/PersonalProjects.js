export const projects = [
  ...
  },
  {
    ...
    noteOnUrl: 'link to download',
    sourceUrl:
      'https://github.com/MatteoPieroni/create-blurred-background-images',
    description:
      'A small Electron, Typescript and styled-components app to create blurred base64 versions of images, to be used as first load version.',
  },
  {
  ...
  {
    name: 'Acest',
    url: 'https://www.npmjs.com/package/acest',
    sourceUrl: 'https://github.com/MatteoPieroni/acest',
    description:
      'A console tool, packaged in NPM, to be used for testing websites accessibility via a config file. It can be used in CI/CD pipelines.',
  },
];
